...
const AnonymousSection = () => {
    return (
        <section className="relative py-5 px-6 overflow-hidden bg-black flex flex-col items-center">
            ...
            <motion.div
                ...
                className="relative  overflow-hidden shadow-2xl flex flex-col items-center justify-center p-8"
                style={{
                    width: "412px",
                    height: "397px",
                    maxWidth: "100%"
            ...
            >
                ...
                {/* Floating Elements with Continuous Looping "In and Out" Animations */}

                {/* Left Side Group (Looping from Left) */}
                ...
                {/* Right Side Group (Looping from Right) */}
                <div className="absolute inset-0 pointer-events-none">
                ...
                {/* Bottom Center (Looping from Bottom) */}
                <motion.div
                    animate={{
                        y: [40, 0, 40],
                        opacity: [0, 1, 0]
                    ...
                    className="absolute bottom-[4%] left-1/2 -translate-x-1/2 w-[130px] z-10"
                >
