    ...
    <div className="relative min-h-screen w-full overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto px-3 sm:px-6 py-4 sm:py-8">
        ...
        <div className="flex flex-row items-center justify-between mb-6 sm:mb-10">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-wide flex-1 text-center text-white">Notifications</h1>
        ...
        {notifications.length === 0 && !loading ? (
          <div className="flex flex-col items-center justify-center min-h-[300px] sm:min-h-[400px]">
            ...
            <div className="text-lg sm:text-2xl font-semibold text-center drop-shadow-lg">No Izhaar notifications</div>
          </div>
        ) : (
          <div className="space-y-4 sm:space-y-6 pb-8 sm:pb-10">
            {notifications.map((item, idx) => (
              <div
                key={item.id || idx}
                className="group bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl p-5 sm:p-8 border border-white/20 shadow-lg cursor-pointer hover:shadow-2xl hover:border-white/40 transition-all duration-300 hover:scale-[1.01] hover:bg-gradient-to-br hover:from-white/15 hover:to-white/8"
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex items-center text-white/70 group-hover:text-white transition text-sm sm:text-base font-semibold">
                    View Letter →
                  </div>
                </div>
              </div>
