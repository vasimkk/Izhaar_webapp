...
import { SIMPLE_IZHAAR } from "../../config/routes";
import api from "../../utils/api";
export default function ReceiverForText() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.replace({ pathname: SIMPLE_IZHAAR, params: { data: JSON.stringify(res.data) } });
    } catch (error) {
